...
RSpec.describe ReservationsController, type: :controller do
  ...
  let(:invalid_attributes) {
    attributes_for(:reservation,:guest=>nil,:restaurant=>nil,:restaurant_table=>nil,:restaurant_shift=>nil)
  }

  let(:invalid_attributes_with_ids) {
    attributes_for(:reservation,:guest_id=>nil,:restaurant_id=>nil,:restaurant_table_id=>nil,:restaurant_shift_id=>nil)
  }
  ...
  describe "POST #create" do
    context "with valid params" do
      ...
      it "renders a JSON response with the new reservation" do
        ...
        post :create, params: {reservation: valid_attributes_with_ids}, session: valid_session
  ...
  describe "PUT #update" do
    ...
    context "with invalid params" do
      it "renders a JSON response with errors for the reservation" do
        reservation = Reservation.create! valid_attributes
        put :update, params: {id: reservation.to_param, reservation: invalid_attributes_with_ids}, session: valid_session
        expect(response).to have_http_status(:unprocessable_entity)
        expect(response.content_type).to eq('application/json')
      end
    end
